...
const Between10kTo20kProducts = (props) => {
  const { searchQuery } = props;
  const filteredProducts2 = All.filter((product) =>
  product.price1 > 10000  && product.price1 < 20000
  );
  ...
  return (
    <>
      <div id="product" className="Product1">
        <h1 id="Product">Between10kTo20k Products</h1>
...
export default Between10kTo20kProducts;
