...
const Between5kTo10kProducts = (props) => {
  const { searchQuery } = props;
  const filteredProducts2 = All.filter((product) =>
  product.price1 > 5000  && product.price1 < 10000
  );
  ...
  return (
    <>
      <div id="product" className="Product1">
        <h1 id="Product">Between5kTo10k Products</h1>
...
export default Between5kTo10kProducts;
