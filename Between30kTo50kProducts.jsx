...
const Between30kTo50kProducts = (props) => {
  const { searchQuery } = props;
  const filteredProducts2 = All.filter((product) =>
  product.price1 > 30000  && product.price1 < 50000
  );
  ...
  return (
    <>
      <div id="product" className="Product1">
        <h1 id="Product">Between30kTo50k Products</h1>
...
export default Between30kTo50kProducts;
