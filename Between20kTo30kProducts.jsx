...
const Between20kTo30kProducts = (props) => {
  const { searchQuery } = props;
  const filteredProducts2 = All.filter((product) =>
  product.price1 > 20000  && product.price1 < 30000
  );
  ...
  return (
    <>
      <div id="product" className="Product1">
        <h1 id="Product">Between20kTo30k Products</h1>
...
export default Between20kTo30kProducts;
